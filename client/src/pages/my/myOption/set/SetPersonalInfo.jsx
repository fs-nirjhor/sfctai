...
const SetPersonalInfo = () => {
  ...
  const handleClick = async (updates) => {
    ...
    try {
      toast.loading(<Spinner text="Updating..." />, {
        toastId: "update-info-loading",
      });
  ...
  return (
    <div>
      ...
      <div className="max-w-md mx-auto pb-20">
        {/* modify name */}
        <form className={formStyle} onSubmit={() => handleClick({ name })}>
          <input
            type="text"
        ...
        {/* modify phone */}
        <form className={formStyle} onSubmit={() => handleClick({ phone })}>
          <input
            type="tel"
        ...
        {/* modify email */}
        <form className={formStyle} onSubmit={() => handleClick({ email })}>
          <input
            type="email"
