  ...
  return (
    <section className="px-2">
      ...
      <div className="bg-mySecondary p-3 rounded-md">
        <p>
          The minimum value of recharge is{" "}
          {configuration?.minimumRecharge || 10} USDT, only USDT is supported
          for recharge, if you use other currencies for recharge, the funds will
          not be returned and the user will bear the loss.
        </p>
        <Link
